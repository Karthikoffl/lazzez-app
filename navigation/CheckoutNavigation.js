...
const CheckoutNavigation = () => {
  return (
    <Stack.Navigator>
        ...
        <Stack.Screen options={{gestureEnabled: false, headerShown: false }} name="Success" component={OrderSuccess} />
        <Stack.Screen options={{ headerShown: false }} name="Failed" component={OrderFailed} />
    </Stack.Navigator>
  );
};
