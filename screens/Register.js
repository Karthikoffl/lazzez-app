    ...
    <MainView>
      ...
      <View style={styles.bottomView}>
        <View style={{padding: 40}}>
            ...
            <TouchableOpacity style={{alignItems: 'center', justifyContent: 'center', marginTop: 30}} onPress={() => navigation.navigate('Login')}>
              <Text style={{fontWeight: 600, fontSize: 16, color: '#F49F1C'}}>Back To Login</Text>
            </TouchableOpacity>
        </View>
        {/* <OrContainer>
          <OrLine />
