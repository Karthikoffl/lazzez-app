    ...
    <MainView>
      <View style={{padding: 20, marginTop: 40}}>
        <TouchableOpacity onPress={() => navigation.goBack()}>
          <Ionicons style={{paddingBottom: 30,}} name="arrow-back" size={30} color="black" />
        </TouchableOpacity>
            <LoginTitle>Get Updates On Your Order Status</LoginTitle>
            <SubTitle>Lorem ipsum dolor sit amet, consectetur adipiscing. Nunc eleifend metus pulvinar mattis.</SubTitle>
            <Image 
