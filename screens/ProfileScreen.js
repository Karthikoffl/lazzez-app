  ...
  return (
    ...
    <Surface style={styles.header}>
      <View style={{flexDirection: 'row', alignItems: 'center', justifyContent: 'center'}}>
        <TouchableOpacity onPress={() => navigation.navigate('Home')} style={{left: -112}}>
    ...
    <TouchableOpacity onPress={() => navigation.navigate("Camera")}>
        ...
        {photo && (<Avatar.Image
          ...
          source= {{ uri: photo }}
        /> )}
        <View style={{position: 'absolute', backgroundColor: '#F49F1C', padding: 5, borderRadius: 50, top: 95, left: 95}} >
    ...
    <Divider />
    <View style={{paddingBottom: 80, alignItems: 'center', justifyContent: 'center'}}>
